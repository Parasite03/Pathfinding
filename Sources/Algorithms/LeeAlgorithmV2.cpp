...
void LeeAlgorithmV2::setWorldSize(sf::Vector2i world_size)
{
	world_size_ = world_size;
}

void LeeAlgorithmV2::setDiagonalMovement()
{
...
sf::Vector2i LeeAlgorithmV2::ftoi(sf::Vector2f vector)
{
	return { (int)vector.x, (int)vector.y };
}

sf::Vector2f LeeAlgorithmV2::itof(sf::Vector2i vector)
{
